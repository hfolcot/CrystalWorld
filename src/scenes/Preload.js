...
class Preload extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON('level-3', 'assets/crystal_world_map_level_3.json');


        this.load.image('bg-spikes-dark', 'assets/bg_spikes_dark.png');
        this.load.image('bg-sky', 'assets/sky_play.png');
        ...
        this.load.audio('swipe', 'assets/music/whoosh.wav');
        this.load.audio('step', 'assets/music/step_mud.wav');
        this.load.audio('jump', 'assets/music/jump.wav');
        this.load.audio('projectile', 'assets/music/swipe.wav');
